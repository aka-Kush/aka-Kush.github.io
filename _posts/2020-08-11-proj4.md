...
{% include figure.html image="/images/proj4/sinevssq.png" alt="Image with just alt text" %}

_Piezo Buzzer_ is a device used to generate basic beeps and tones. It generates a square wave which is not pleasant to hear with comparison to sine waves due to
