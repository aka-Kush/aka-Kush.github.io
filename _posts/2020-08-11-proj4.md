...
_Piezo Buzzer_ is used to generate basic beeps and tones. It generates a square wave which is not pleasant to hear with comparison to sine waves due to
