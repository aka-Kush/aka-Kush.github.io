...
Today we'll be setting up the environment and will get familiar with the Hardware and Software Interface.
...
{% include figure.html image="/images/kit.jpg" alt="Image with just alt text" %}
...
{% include figure.html image="/images/interface.png" alt="Image with just alt text" %}
...
{% include figure.html image="/images/examples.png" alt="Image with just alt text" %}
At the top of the screen there are many options. The file option is basically used to Save the current sketch or open any
alread made sketch. There is also an examples option in the file which includes some pre-writeen sketch examples which can directly be uploaded
to the Arduino.

{% include figure.html image="/images/sketch.png" alt="Image with just alt text" %}
...
Hardware Interface:
{% include figure.html image="/images/arduino.jpg" alt="Image with just alt text" %}
